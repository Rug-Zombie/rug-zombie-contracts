...
module.exports = async function (deployer) {
    ...
    // await deployer.deploy(
    //     GraveStakingToken,
    //     "MonsterSlayer Rare - Rug Zombie Grave Staking Token",
    //     "MSC-RARE-RZ-STAKING"
    // );
    ...
    // );
    // const fairmoonRare = await GraveStakingToken.deployed();
    // fairmoonRare.transferOwnership(DrFrankenstein.address);
    //
    // // Fairmoon Uncommon
    // await deployer.deploy(
    //     GraveStakingToken,
    ...
    // await deployer.deploy(
    //     GraveStakingToken,
    //     "Merlin Lab Rare - Rug Zombie Grave Staking Token",
    //     "MERL-RARE-RZ-STAKING"
    // );
    // const merlRare = await GraveStakingToken.deployed();
    // merlRare.transferOwnership(DrFrankenstein.address);

    // Launch NFT's
    // await deployer. deploy(RevivedRugNft, "Basic Zombie", "BASIC-ZMBE");
    // const frankNft = await RevivedRugNft.deployed();
    // // await frankNft.setTokenURI("ipfs://QmemcCajnozKxKMtpjohNsjejvH2TtPiBWBP3YrfvmcyKN");
    ...
    //
    // await deployer.deploy(RevivedRugNft, "Zombie on the Moon", "Z-MOON");
    ...
    //
    // await deployer.deploy(RevivedRugNft, "DragonFarm Finance Common", "DRAGON-COMMON");
    ...
    // await deployer.deploy(RevivedRugNft, "Merlin Lab Rare", "MERL-RARE");
    // const merlRareNft = await RevivedRugNft.deployed();
    // await yPandaCommonNft.setTokenURI("ipfs://QmUnxRU1ZcF4EFYNuJmsTVE7VahWBx3e7TCgZYTZR4Ytrj");
    // await yPandaCommonNft.transferOwnership(DrFrankenstein.address);
    // Add Graves
    ...
    // await drFrankenstein.addGrave(
    //     200,                                            // _allocPoints
    //     yPandaCommon.address,                           // _lpToken
    //     259200,                                         // _minimumStakingTime
    //     "0x9806aec346064183b5cE441313231DFf89811f7A",   // _ruggedToken
    //     yPandaCommonNft.address,                        // _nft
    //     "1000000000000000000000",                       // _minimumStake
    //     "5000000000000000000",                          // _unlockFee
    //     604800,                                         // _nftRevivalTime
    //     true                                            // _withUpdate
    ...
    // await drFrankenstein.addGrave(
    //     800,                                            // _allocPoints
    //     merlRare.address,                               // _lpToken
    //     259200,                                         // _minimumStakingTime
    //     "0xda360309c59cb8c434b28a91b823344a96444278",   // _ruggedToken
    //     merlRareNft.address,                            // _nft
    //     "5000000000000000000000",                       // _minimumStake
    //     "5000000000000000000",                          // _unlockFee
    //     2592000,                                        // _nftRevivalTime
    //     false                                           // _withUpdate
